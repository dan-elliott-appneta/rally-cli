...
DEFAULT_FETCH_FIELDS = {
    "HierarchicalRequirement": [
        ...
        "Description", "Notes", "Iteration", "PlanEstimate",
        "ObjectID", "PortfolioItem",
    ],
    "Defect": [
        "FormattedID", "Name", "State", "Owner",
        "Description", "Notes", "Iteration", "PlanEstimate",
        "ObjectID", "PortfolioItem",
    ],
    "Task": [
        "FormattedID", "Name", "State", "Owner",
        "Description", "Notes", "Iteration", "Estimate",
        "ObjectID",
    ],
    "Iteration": [
        "ObjectID", "Name", "StartDate", "EndDate", "State",
    ],
    "ConversationPost": [
        "ObjectID", "Text", "User", "CreationDate", "Artifact",
    ],
    "Attachment": [
        "ObjectID", "Name", "Size", "ContentType",
    ],
    "User": [
        "ObjectID", "DisplayName", "UserName", "EmailAddress",
    ],
